...
import { NotesContext, selectNoteContext,MarkedNotesContext } from "../../utils/NotesHooks/NotesContext";
import { useNavigate } from "react-router-dom";

export function SideNotes({Note,all,marked,setViewAll,setViewMarked}) {
...
const dayName = days[currentDate.getDay()];
 ...
 return (
    <>
    {all && <div className="noteDiv" key={Note.id} onClick={() => {
